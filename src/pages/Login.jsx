    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-white">Welcome to Ascend</h2>
          <p className="mt-2 text-sm text-gray-400">Level up your life, one habit at a time</p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-lg relative block w-full px-3 py-2 mt-1 border border-gray-700 bg-gray-700 text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
